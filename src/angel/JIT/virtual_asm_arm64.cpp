...
#ifdef __APPLE__
#ifndef Q_PROCESSOR_X86_64 //Qt5 does not have Q_PROCESSOR_ defined for Apple Silicon
...
//See https://github.com/CAS-Atlantic/AArch64-Encoding for a list of Apple ARM64 opcode bytes
